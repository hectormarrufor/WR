      ...
      <Card   shadow="sm" padding="lg">
        ...
        {renglones.map((r, index) => (
          <Card key={r.id} shadow="sm" padding="md"   mb="md">
            <Flex>
              <Image src={`${process.env.NEXT_PUBLIC_BLOB_BASE_URL}/${r.imagen}?v=${process.env.NEXT_PUBLIC_APP_VERSION}`} height={150} mx={20} radius={10} alt={r.modelo.nombre} />
              <Group>
          ...
          {activos
            ...
            .map((a) => (
              <Card key={a.id} shadow="sm" padding="md"  >
                <Image src={`${process.env.NEXT_PUBLIC_BLOB_BASE_URL}/${a.imagen}?v=${process.env.NEXT_PUBLIC_APP_VERSION}`} height={100} alt={a.modelo.nombre} />
