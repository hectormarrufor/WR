...
import { VehiculosAsignadosTable } from './VehiculosAsignadosTable';
import { RenglonesOperacionTable } from './RenglonesOperacionTable';
import { TrabajosExtraTable } from './TrabajosExtraTable';
import { OrdenesCompraOperacionTable } from './OrdenesCompraOperacionTable';

// Recibimos los params que nos pasó la página
export default function OperacionCampoDetailContent({ params }) {
  const { id } = params;
  const router = useRouter();
  const searchParams = useSearchParams(); // Ahora esto es seguro
